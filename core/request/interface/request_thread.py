...
class RequestThread(BetterThread, ABC):
    ...
    def __init__(self):
        super().__init__(name="RequestThread")
    ...
    def create_request_thread_by_config(config: dict):
        ...
        if config.get('request_type') == RequestType.BROWSER_CHROME_SINGLE_TAB:
            ...
            return ChromeSingleTabRequest.create_request_thread_by_config(config)
        # Chrome 多标签
            ...
            return ChromeMultiTabRequest.create_request_thread_by_config(config)
